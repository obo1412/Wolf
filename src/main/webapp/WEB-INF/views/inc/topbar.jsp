...
<header class="topbar" data-navbarbg="skin5">
	<nav class="navbar top-navbar navbar-expand-md navbar-dark">
		<div class="navbar-header" data-logobg="skin5">
			...
			<!-- Logo -->
			<!-- ============================================================== -->
			<a class="navbar-brand" href="${pageContext.request.contextPath}/index.do"> <!-- Logo icon --> <b
				class="logo-icon p-l-10"> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
					<!-- Dark Logo icon --> <img src="${pageContext.request.contextPath}/assets/matrix-admin-libs/images/logo-icon.png"
					alt="homepage" class="light-logo" />

			</b> <!--End Logo icon --> <!-- Logo text -->
				<span class="logo-text">
					<!-- dark Logo text --> <%-- <img src="${pageContext.request.contextPath}/assets/matrix-admin-libs/images/logo-text.png"
					alt="homepage" class="light-logo" /> --%>
					우리동네 프로선수들
		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent"
			...
			<ul class="navbar-nav float-right">
				...
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"><img src="${pageContext.request.contextPath}/assets/matrix-admin-libs/images/users/1.jpg"
